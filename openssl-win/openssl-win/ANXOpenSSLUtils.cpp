...
// copy encoded output to a memory block
        ...
        *out_len = ptr->length;
        *out = (char*)OPENSSL_malloc(((*out_len) + 1) * sizeof(char));
...
// allocate output buffer
        * out = (unsigned char*)OPENSSL_malloc(in_len * sizeof(unsigned char));
        ...
        *out = (unsigned char*)OPENSSL_realloc((void*)*out, *out_len * sizeof(unsigned char));
